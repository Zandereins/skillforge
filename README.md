...
| 367+ Tests (unit + integration + proof) | +28 edge-case tests, +76 pattern tests, +20 golden-file tests |
...
| Tests | **367+ passing** | 248 unit + 99 integration + 20 self + 6 proof. Every scorer rule tested. |
